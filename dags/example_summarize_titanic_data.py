...
default_args={
    "owner": "john.hiett@broadcom.com,Open in Cloud IDE",
}

@dag(
    default_args=default_args,
    schedule=None,
    start_date=pendulum.from_format("2024-12-04", "YYYY-MM-DD"),
    catchup=False,
    owner_links={
        "john.hiett@broadcom.com": "mailto:john.hiett@broadcom.com",
        "Open in Cloud IDE": "https://cloud.astronomer.io/cm472xqme16jm01mxi0q1843u/cloud-ide/cm49qavrm1o5z01o6mo40qrw0/cm49qawbe1o6001o632gt7inh",
    },
)
